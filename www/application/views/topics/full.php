...
echo "Return to ".anchor('topics/single/'.$parent->topic_id,$parent->name);
...
if ($publicationCount == 1) 
	$topicstatBlock .= "
<ul>
<li class='nobr'>{$publicationCount} ".__('publication')."</li>";
else 
	$topicstatBlock .= "
<ul>
<li class='nobr'>{$publicationCount} ".__('publications')."</li>";
if ($authorCount ==1)
$topicstatBlock .="
